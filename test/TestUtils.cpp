...
INSTANTIATE_TEST_CASE_P(HexStrings, isHexStrTrue, ::testing::Values(
  "00",
  "1",
  "a",
  "A",
...
INSTANTIATE_TEST_CASE_P(NonHexStrings, isHexStrFalse, ::testing::Values(
  "1G",
  "ag",
  " ",
  ".",
...
INSTANTIATE_TEST_CASE_P(Translatable, char2HexChars, ::testing::Values(
  char2HexCase{ '0', 0 },
  char2HexCase{ '1', 1 },
  char2HexCase{ '2', 2 },
  char2HexCase{ '3', 3 },
...
INSTANTIATE_TEST_CASE_P(NonTranslatable, char2HexNonChars, ::testing::Values(
  'g',
  'G',
  '-',
  '+',
...
INSTANTIATE_TEST_CASE_P(Translatable, hex2CharSingleDigit, ::testing::Values(
  hex2CharCase{ 0, '0' },
  hex2CharCase{ 1, '1' },
  hex2CharCase{ 2, '2' },
  hex2CharCase{ 3, '3' },
