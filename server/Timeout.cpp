...
Timeout::Timeout () :
  mTimeoutType (Timeout::Type::NONE),
...
Timeout::Timeout (const duration <double> realTimeout) :
  mTimeoutType (Timeout::Type::REAL),
...
void
Timeout::realTimeout (const duration <double> realTimeout)
{
...
void
Timeout::cycleTimeout (const uint64_t cycleTimeout)
{
...
bool
Timeout::timedOut (ITarget * cpu) const
{
  switch (mTimeoutType)
    {
    case Type::NONE:
